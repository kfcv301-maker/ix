...
export const panelThemes = [
  ...
  { id: 'dora-sky', name: '哆啦蓝', description: '清爽蓝色、圆润卡片与轻量二次元感' },
  { id: 'akcdn-console', name: 'AKCDN 风格', description: '浅色蓝调、运营控制台层级与高密度数据卡片' },
  { id: 'nvenix-minimal', name: 'Nvenix 极简', description: '纸白底色、墨色主按钮、细边框与克制层次' },
